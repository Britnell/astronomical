...
export default component$(({ data }: { data: Movies[] }) => {
  return (
    <div>
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(3,1fr)] ">
          <Squares n={3} />
        </div>
      </section>
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(3,1fr)]  overflow-auto">
          <>
            {data.slice(0, 3).map((_mov, m) => {
              ...
              return (
                <div class=" bg-gray-200 ">
                  <MovieImg path={mov.poster_path} class=" " />
                  <h3 class=" font-serif text-4xl font-bold">{mov.title}</h3>
                  <p class=" whitespace-pre ">{mov.overview}</p>
                </div>
              );
            })}
          </>
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(3,minmax(100px,300px))] justify-center  ">
          <MovieCards data={data} n={3} />
        </div>
      </section>
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(auto-fill,minmax(200px,1fr))] justify-center ">
          <MovieCards data={data} n={3} />
        </div>
      </section>
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(auto-fit,minmax(200px,1fr))] justify-center ">
          <MovieCards data={data} n={3} />
        </div>
      </section>
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(auto-fill,minmax(140px,1fr))] justify-center ">
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[repeat(auto-fill,minmax(0,450px))] justify-center ">
      ...
      <section>
        ...
        <div class="grid gap-4 grid-cols-[fit-content(300px)_1fr] ">
          <p class="x">{data[0].overview}</p>
          <div>
            <MovieCards data={data} n={1} />
          </div>
        </div>
            ...
            {data.slice(0, 2).map((mov, m) => (
              <>
                <MovieImg
                  ...
                  class={" w-full aspect-[3] object-cover screenwidth"}
                />
                <h3>{mov.title}</h3>
                <p>{mov.overview}</p>
              </>
          ...
          <>
            {data.slice(0, 2).map((mov, m) => (
              <>
                ...
                <p>{mov.overview}</p>
                {m === 0 && (
                  <div class="full-width bg-blue-500 font-serif text-7xl  text-white">
